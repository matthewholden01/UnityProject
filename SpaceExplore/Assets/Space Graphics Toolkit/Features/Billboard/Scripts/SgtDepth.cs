...
namespace SpaceGraphicsToolkit
{
		...
		where T : SgtDepth
	{
		...
		{
			Draw("Layers", "The layers that will be sampled when calculating the optical depth."); // Updated automatically
			Draw("Ease", "The transition style between 0..1 depth."); // Updated automatically
		}
	}
}
#endif