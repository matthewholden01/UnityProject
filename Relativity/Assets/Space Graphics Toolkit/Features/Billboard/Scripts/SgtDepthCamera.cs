	...
	public class SgtDepthCamera_Editor : SgtDepth_Editor<SgtDepthCamera>
	{
		protected override void OnInspector()
		{
			...
			BeginError(Any(t => t.Resolution < 0));
				Draw("Resolution", "The width & height of the camera RenderTexture in pixels."); // Updated automatically
			EndError();
			BeginError(Any(t => t.Size <= 0.0f));
				Draw("Size", "The width & height of the camera viewport in world space."); // Updated automatically
			EndError();
		}
	}
}
